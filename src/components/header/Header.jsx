        ...
        <Container>
          <div className="mx-auto flex max-w-8xl items-center justify-between px-1 py-2 sm:px-6 lg:px-16">
            ...
            <div className="inline-flex items-center space-x-2">
              <span>
              {/* <img className="w-28 " src="https://appsgeyser.com/blog/wp-content/uploads/2020/12/blogging-fun-content-creation-online-streaming-video-blog-young-girl-making-selfie-social-network-sharing-feedback-self-promotion-strategy-vector-isolated-concept-metaphor-illustration_335657-855.jpg" alt="" srcset="" /> */}
              </span>
            ...
            <div className="flex grow justify-end">
              <input
                className="hidden md:block flex h-10 w-[200px] sm:w-[250px] text-gray-800  rounded-md bg-gray-100 px-3 py-2 text-sm placeholder:text-gray-600 focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                type="Search..."
                placeholder="Search"
              ></input>
            </div>
            ...
            {isMenuOpen && (
              <div className="absolute inset-x-0 top-0 z-50 origin-top-right transform p-2 transition lg:hidden">
                ...
                {/* <span className="absolute bottom-0 left-0 block h-2.5 w-2.5 rounded-full bg-green-600 ring-2 ring-white"></span> */}
                {/* <div className="group-hover:block hidden " ><User/></div> */}
                {accountMenu && <div ref={buttonRef} className="translate-x-36 mt-8"><User /></div>}
                    </div>
                  </div>
                </div>
              </div>
