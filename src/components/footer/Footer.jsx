...
const Footer = () => {
  return (
    <div className='w-full left-0 bg-white bottom-0 border-t border-gray-400  mt-20'>
          ...
          <div className="w-auto p-8">
            <a href="#">
              <div className="inline-flex items-center">
                ...
                <span className="ml-4 text-lg font-bold">BLOG APP</span>
              </div>
            </a>
          </div>
          <div className="w-auto p-8">
            ...
            <div className="-m-1.5 flex flex-wrap">
              <div className="w-auto p-1.5">
                <a href="https://marketingplatform.google.com/about/tag-manager/">
                  <div className="flex h-8 px-4  items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
                 Google tag manager
                  </div>
                </a>
              </div>
